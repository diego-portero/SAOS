...
load_filename_modalBasis = os.path.join(os.path.expanduser("~"), 'simulations/modal_basis/20260223_1834.h5')
load_filename_IM = os.path.join(os.path.expanduser("~"), 'simulations/interaction_matrix/20260223_1834.h5')
