...
# Loading files:
# load_filename_atm = os.path.join(os.path.expanduser("~"), 'simulations/phase_screens/ps_dualARM_EST_spider_case2_draw1.h5')
load_filename_atm = os.path.join(os.path.expanduser("~"), 'simulations/phase_screens/dmFittingTest_8cm.h5')
load_filename_modalBasis = os.path.join(os.path.expanduser("~"), 'simulations/modal_basis/dmFittingTest.h5')
load_filename_IM = os.path.join(os.path.expanduser("~"), 'simulations/interaction_matrix/dmFittingTest.h5')
...
# sharepoint = Sharepoint(test_logger.logger, port=5574, atm=1, atm_per_dir=1, dm=1, dm_per_dir=1, slopes=1, wfs=1, wfs_frame=1, sci=1, sci_frame=1)
...
scao_light_path_list[-1].initialize_path(src=sun_red, atm=atm, tel=est_tel, dm=dms[0], wfs=red_wfs, vibration=red_vibrations, sci=red_scicam, delay=0)
