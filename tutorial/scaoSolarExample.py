...
# Loading files:
load_filename_atm = os.path.join(os.path.expanduser("~"), 'simulations/phase_screens/ps_scaoExample_r21cm.h5')
...
asm_params = {'dynamicModel': '', 'validThreshPercentage': 0.7533}
